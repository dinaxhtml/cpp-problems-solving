...
For example, the great blue heron is bringing garlic naan and
...
int main() {
    ...
    cout<<feast("chickadee", "chocolate cake")<<endl;//1 true
    cout<<feast("marmot", "mulberry tart")<<endl;//1 true
    cout<<feast("electric eel", "lasagna")<<endl;//0 false
